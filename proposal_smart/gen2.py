...
FREQ = [
 ...
 ('갑상선결절', 'D34', 'thyroid', '갑상선 부분절제술', '급여 · 3종 수술', dict(surg='57', surg7='K076', grp=['다빈도62대질병']), [['수술', '갑상선 부분절제', '', ['surg'], {'j': 3}]]),
 ...
 ('자궁근종', 'D25', 'cervical_cancer', '복강경 자궁근종 절제술', '급여 · 2종 수술', dict(surg='52', surg7='N031', grp=['다빈도62대질병']), [['수술', '복강경 근종 절제', '', ['surg'], {'j': 2}]]),
