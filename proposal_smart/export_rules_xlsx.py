...
특약 마스터(db.json) 1,758건을 실제로 이 규칙표에 통과시켜 규칙마다 몇 건이 걸리는지,
...
ACTS = {
    'surg': '수술', 'robot': '다빈치 로봇수술', 'anes': '종합병원 전신마취 수술', 'anes4': '4시간 이상 전신마취 수술', 'anes6': '6시간 이상 전신마취 수술',
...
COLS = [
    ...
    ('적용 담보 수', 11, '특약 마스터 1,758건 중 이 규칙에 걸리는 담보 수'),
