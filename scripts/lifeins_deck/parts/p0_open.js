...
module.exports = async function(p, L){
  ...
  // 2. 왜 다시 배워야 하나 --------------------------------------------
  {
    ...
    notes(s, '도입부. 4가지 변화 요인을 짚고, 기존 교안이 왜 업데이트가 필요한지 공감대를 만듭니다.');
  }
  ...
  // 4. 아이스브레이킹: 생보 증권을 만나면 ------------------------------
  {
    ...
    notes(s, '아이스브레이킹. 손을 들어보게 하세요. 대부분 왼쪽입니다. 2020년 EM교안의 오프닝을 계승했습니다.');
  }
  ...
  // 5. 워밍업: 10억 버스 이야기 -----------------------------------------
  {
    ...
    notes(s, '2020년 「생보 vs 손보」 교안의 실제 사례. 교통재해사망특약(대중교통 이용 중 재해사망 시 고액)을 「사망 시 10억」으로 기억하는 고객 이야기입니다.');
  }
};
